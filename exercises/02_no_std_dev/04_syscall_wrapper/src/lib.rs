...
pub unsafe fn syscall3(id: usize, arg0: usize, arg1: usize, arg2: usize) -> isize {
    ...
    core::arch::asm!(
        ...
        in("rdi") arg0 as usize,
        in("rsi") arg1 as usize,
        in("rdx") arg2 as usize,
        out("rcx") _,
        out("r11") _,
    );
    ret
...
pub unsafe fn syscall3(id: usize, arg0: usize, arg1: usize, arg2: usize) -> isize {
    ...
    core::arch::asm!(
        "svc #0",
        in("x8") id as usize,
        inlateout("x0") arg0 as usize => ret,
        in("x1") arg1 as usize,
        in("x2") arg2 as usize,
    );
    ret
...
pub fn sys_write(fd: usize, buf: &[u8]) -> isize {
    ...
    let buf_len = buf.len();
    unsafe { syscall3(NATIVE_SYS_WRITE, fd, buf_ptr, buf_len) }
}
...
pub fn sys_read(fd: usize, buf: &mut [u8]) -> isize {
    ...
    let buf_len = buf.len();
    unsafe { syscall3(NATIVE_SYS_READ, fd, buf_ptr, buf_len) }
}
